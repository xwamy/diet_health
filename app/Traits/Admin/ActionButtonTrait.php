...
trait ActionButtonTrait
{
    ...
    public function getActionButtonsOnlyEdit($actionModel,$id = null)
    {
        return $this->editButton($actionModel,$id);
    }

    public function getActionButtonsOnlyDel($actionModel,$id = null)
    {
