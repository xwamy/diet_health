...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">口味</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">口味</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        ...
                        @if(auth('admin')->user()->can('taste.add'))
                            <a href="{{ url('admin/taste/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/taste.list.js')}}"></script>
    <script>
        $(function(){
