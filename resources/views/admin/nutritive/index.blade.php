...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">营养价值</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">营养价值</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        {{--@permission('nutritive.add')--}}
                        @if(auth('admin')->user()->can('nutritive.add'))
                            <a href="{{ url('admin/nutritive/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/nutritive.list.js')}}"></script>
    <script>
        $(function(){
