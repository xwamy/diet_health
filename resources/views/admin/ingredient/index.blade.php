...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">食材</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">食材</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        {{--@permission('ingredient.add')--}}
                        @if(auth('admin')->user()->can('ingredient.add'))
                            <a href="{{ url('admin/ingredient/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/ingredient.list.js')}}"></script>
    <script>
        $(function(){
