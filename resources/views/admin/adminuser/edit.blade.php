                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/adminuser/'.$userData['user']['id']) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="old_password" placeholder="密码" data-parsley-length="[5,12]" data-parsley-length-message="密码长度5~12字符" value="{{ old('old_password') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
