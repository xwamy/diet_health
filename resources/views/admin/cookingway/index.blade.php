...
@section('admin-content')
    <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">烹饪方式</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">烹饪方式</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                    ...
                    <div class="panel-body">
                        {{--@permission('cookingway.add')--}}
                        @if(auth('admin')->user()->can('cookingway.add'))
                            <a href="{{ url('admin/cookingway/create') }}">
...
@section('admin-js')
    ...
    <script src="{{ asset('asset_admin/js/cookingway.list.js')}}"></script>
    <script>
        $(function(){
